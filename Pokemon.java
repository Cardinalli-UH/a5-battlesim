...
public abstract class Pokemon {
	...
	private double[] cpMultiplier = //size=40 (0-39)
	 ...
	 *@param baseStaminaPower The low limit of Stamina Power for species. 
	 **/
	public Pokemon(String species, String name, 
		...
		//generate initial level (normal)
		//this.level = (double) randGen.nextInt(40) + 1;
		//generate initial level (battlesim)
		this.level = 40;
	 ...
	 */
	protected abstract void beAttacked(int damage);
