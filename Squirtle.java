 ...
 * Implements WaterType interface.
...
public class Squirtle extends Pokemon implements WaterType {
	 ...
	 * @param name
	 *            The optional user-given name.
	 * @param num
	 *            The Pokedex number for this species.
	 * @param ht
	 *            The height of this Pokemon.
	 * @param wt
	 *            The weight of this Pokemon.
	 * @param baseAttackPwr
	 *            The low limit of Attack Power for species.
	 * @param baseDefensePwr
	 *            The low limit of Defense Power for species.
	 * @param baseStaminaPwr
	 *            The low limit of Stamina Power for species.
	 */
	...
	/**
	 * Water-type specific fast attack chooser. Randomly picks an attack from
	 * type attack arrays
	 */
	@Override
	protected void chooseFastAttack() {
		...
		int index = randGen.nextInt(WATER_FAST_ATTACKS.length);
	...
	/**
	 * Water-Type specific special attack chooser. Randomly picks an attack from
	 * type interface attack arrays
	 */
	@Override
