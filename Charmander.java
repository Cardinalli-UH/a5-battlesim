...
public class Charmander extends Pokemon implements FireType {
	...
	/**
	 * Fire-type specific fast attack chooser. Randomly picks an attack from
	 * type attack arrays
	 */
	@Override
	protected void chooseFastAttack() {
		...
		int index = randGen.nextInt(FIRE_FAST_ATTACKS.length);
	...
	/**
	 * Fire-ype specific special attack chooser. Randomly picks an attack from
