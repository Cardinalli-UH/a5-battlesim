...
public class Ivysaur extends Bulbasaur {
	 ...
	 * be set after construction of Pokemon Object because of dependence on type
	 * interface
	 * 
	...
	protected Ivysaur(String species, String name, int num, double ht,
		...
		super(species, name, num, ht, wt, baseAttackPwr, baseDefensePwr,
				baseStaminaPwr);
	}
