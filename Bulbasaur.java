 ...
 * Dual-type Grass|Poison implements two types.
 * interfaces Parent class to Ivysaur.
 * 
 * @author Lisa Miller
 * @version 1.0
 * @since 9/24/2016
...
public class Bulbasaur extends Pokemon implements GrassType, PoisonType {
	...
	static final int BASE_DEFENSE_POWER = 118;
	 ...
	 * must be set after construction of Pokemon Object because of dependence on
	 * type interface
	 */
	public Bulbasaur() {
		super("Bulbasaur", "Bulbasaur", 1, GRASS_COLOR, 0.71, 6.9, GRASS_TYPE,
				POISON_TYPE, BASE_ATTACK_POWER, BASE_DEFENSE_POWER,
				BASE_STAMINA_POWER);
	 ...
	 * be set after contsruction of Pokemon Object because of dependence on type
	 * interface
	 * 
	 * @param name The user-defined name.
	 */
	public Bulbasaur(String name) {
		super("Bulbasaur", name, 1, GRASS_COLOR, 0.71, 6.9, GRASS_TYPE,
				POISON_TYPE, BASE_ATTACK_POWER, BASE_DEFENSE_POWER,
				BASE_STAMINA_POWER);
		// pick Attacks
		chooseFastAttack();
	...
	/**
	 * Constructor with species and name for subclasses. This allows subclass
	 * specific name, number, height, weight, and basePowers to pass through to
	 * Pokemon superclass constructor
	 * 
	...
	protected Bulbasaur(String species, String name, int num, double ht,
		...
		super(species, name, num, GRASS_COLOR, ht, wt, GRASS_TYPE, POISON_TYPE,
	...
	/**
	 * Grass|Poison-type specific fast attack chooser. Randomly picks whether
	 * attack type is grass or poison Randomly picks an attack from type attack
	 * arrays
	 */
	...
	/**
	 * Grass|Poison-type specific special attack chooser. Randomly picks whether
	 * attack type is grass or poison Randomly picks an attack from type
	...
	/**
	 * Reduces Pokemon's HP by damage/defensePower. Doesn't allow HP to go less
	 * than 0 Implementation of "fainting" not done here
	 * 
